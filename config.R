...
ext_global <- ext(-180, 180, -60, 85) # rely on package of terra
...
#
# - veg_topo_extr_dir:
#   Stores large datasets, including raw, intermediate, and output data.
#
# - Raw data locations:
#   - /data/archive/
#   - /data_2/archive/
...
sw_in_uneven_450m_path <- file.path(veg_topo_extr_dir, "data/global_sw_in_450m/sw_in_uneven_450m.nc") # r_terrain, Consider slope and aspect
sw_in_flat_450m_path <- file.path(veg_topo_extr_dir, "data/global_sw_in_450m/sw_in_flat_450m.nc") # r_flat
