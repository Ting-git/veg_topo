...
Rscript -e '
  ...
  cat("Session info:\n");
  print(sessionInfo());
  cat("\nRunning script: ~/veg_topo/vignettes/06_re2_regions_validation.Rmd\n");
  rmarkdown::render("~/veg_topo/vignettes/06_re2_regions_validation.Rmd");
'
