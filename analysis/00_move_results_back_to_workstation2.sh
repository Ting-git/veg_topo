...
rsync -avhP --no-perms --no-owner --no-group \
  --human-readable -i --info=progress2 \
  --exclude='*/' \
  tt22k003@submit04.unibe.ch:/storage/scratch/giub_geco/tting/global_sw_in_450m/ \
...
rsync -avhP --no-perms --no-owner --no-group \
  ...
  tt22k003@submit04.unibe.ch:/storage/scratch/giub_geco/tting/global_dem_slope_aspect_450m/ \
  /data_2/scratch/ting/veg_topo_data/data/global_dem_slope_aspect_450m/

# global_r_H_R_5km
rsync -avhP --no-perms --no-owner --no-group \
  --exclude='*/' --human-readable -i --info=progress2 \
  tt22k003@submit04.unibe.ch:/storage/scratch/giub_geco/tting/global_r_H_R_5km/ \
  /data_2/scratch/ting/veg_topo_data/data/global_r_H_R_5km/

# global_cor_twi_vegh
rsync -avhP --no-perms --no-owner --no-group \
  --exclude='*/' --human-readable -i --info=progress2 \
  tt22k003@submit04.unibe.ch:/storage/scratch/giub_geco/tting/global_cor_twi_vegh/ \
  /data_2/scratch/ting/veg_topo_data/data/global_cor_twi_vegh/

# reg_sample
rsync -avhP --no-perms --no-owner --no-group \
  --human-readable -i --info=progress2 \
  tt22k003@submit04.unibe.ch:/storage/scratch/giub_geco/tting/reg_sample/ \
  /data_2/scratch/ting/veg_topo_data/data/reg_sample/

# reg_validate_500m
rsync -avhP --no-perms --no-owner --no-group \
  --human-readable -i --info=progress2 \
  tt22k003@submit04.unibe.ch:/storage/scratch/giub_geco/tting/reg_validate_500m/ \
