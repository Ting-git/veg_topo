...
p_ai <- plot_density_by_cluster(df, "ai", "cluster7c", mean_df, "mean_ai", "Aridity index distribution",
                                facet_ncol = 1, scales = "fixed")
...
ggsave(filename = here::here("data/figures/03_kmeans_7c_ai_density.png"),
...
pbox_ai     <- plot_box_or_violin(df, "cluster7c", "ai",     "boxplot", "AI", fill_colors)
pvio_ai     <- plot_box_or_violin(df, "cluster7c", "ai",     "violin",  NULL, fill_colors)
