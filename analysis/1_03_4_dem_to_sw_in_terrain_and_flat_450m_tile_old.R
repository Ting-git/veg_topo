...
if (!dir.exists(sw_in_flat_450m_tile_dir)) dir.create(sw_in_flat_450m_tile_dir, recursive = TRUE)
if (!dir.exists(sw_in_uneven_450m_tile_dir)) dir.create(sw_in_uneven_450m_tile_dir, recursive = TRUE)
